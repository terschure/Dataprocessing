...
// get ingredients
var list = document.getElementById("ingredient-list").getElementsByTagName("li");
for (var i = 0; i < list.length; i++){
    var ingredient = list[i].innerHTML;
    ApplePie.ingredients.push(ingredient);
};
...
document.getElementsByTagName("img")[0].addEventListener("click", log);
...
// Make sure to test your createTransform function thoroughly
